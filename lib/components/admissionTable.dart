...
class AdmissionTable extends StatefulWidget {
  ...
  @override
  AdmissionTableState createState() => AdmissionTableState();
}

class AdmissionTableState extends State<AdmissionTable> {
  ...
  @override
  void didUpdateWidget(AdmissionTable oldWidget) {
              ...
              ElevatedButton(
                onPressed: () async {
                  ...
                  if (_selectedIds.isNotEmpty && _selectedDateTime != null) {
                    ...
                    try {
                      final response = await Apiservice.changeSchedule(_selectedIds,_selectedDateTime);
            ...
            rows: widget.studentData.asMap().entries.map((entry) {
              ...
              return DataRow(
                cells: <DataCell>[
                  ...
                  DataCell(Text(student['admissionNumber'].toString())),
                  DataCell(Text('${student['fname']} ${student['lname']}')),
                  DataCell(Text(student['email'])),
                  DataCell(Text(student['examSchedule'])),
